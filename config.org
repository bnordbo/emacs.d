...
(custom-theme-set-faces
 ...
 '(fixed-pitch ((t (:family "Fira Mono" :height 130)))))
#+end_src
...
(use-package go-mode
  ...
  (setq go-eldoc-gocode "/etc/profiles/per-user/bn/bin/gocode")
...
The property drawers can make org files look messy, and this will tidy them up.
