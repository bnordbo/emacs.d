...
After switcing to native compilation, the warning buffer started to pop up a lot. Increasing the log level to ~error~ takes care of that annoyance.
...
;;   :ensure t
;;   :custom
;;   ((chatgpt-shell-api-url-base "https://chat-ai.cisco.com")
;;    Only exists in documentation
;;    (chatgpt-shell-api-url-path "/openai/deployments/gpt-4o-mini/chat/completions")
;;    (chatgpt-shell-openai-key
;;     (lambda ()
;;      (auth-source-pick-first-password :host "token.cisco.com")))))
#+end_src
