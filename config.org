...
*** DONE Make C-c C-x C-j work globally                               :emacs:
    CLOSED: [2020-10-14 Wed 19:18]
    :LOGBOOK:
    CLOCK: [2020-10-14 Wed 19:16]--[2020-10-14 Wed 19:18] =>  0:02
    :END:
...
(setq org-agenda-custom-commands
      '(("i" "Inbox"
         ((todo "TODO"
                ((org-agenda-files (list (format "%s/%s.org" org-directory "inbox")))))))
...
** DONE Maybe move global keys to a separate section                  :emacs:
   CLOSED: [2020-10-12 Mon 23:02]
